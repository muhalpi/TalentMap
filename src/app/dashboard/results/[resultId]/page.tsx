...
function participantName(result: Awaited<ReturnType<typeof getClientResultDetail>>) {
  if (!result) {
...
function participantDetail(
  result: NonNullable<Awaited<ReturnType<typeof getClientResultDetail>>>,
) {
            ...
            <dl className="mt-3 space-y-3">
              <div className="flex justify-between gap-4 border-t border-border pt-3">
                ...
                <dd className="text-right">
                  {result.participant?.profileHref ? (
                    <Link
                      href={result.participant.profileHref}
